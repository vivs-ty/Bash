...
- Detailed beginner walkthrough with examples: `Beginner.md`
- Practice tasks for this phase: `../Tasks/Readme.md` (Phase 1 tasks 1-70)
...
- **Loops**
  - **`for` loop:** Iterating over a sequence of items.
    ...
    - Safer file iteration: `for file in ./*.txt; do ... done`
